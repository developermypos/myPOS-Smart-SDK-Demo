...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Utils.PAYMENT_REQUEST_CODE) {
            ...
            if (status == Utils.TRANSACTION_STATUS_SUCCESS || status == Utils.TRANSACTION_STATUS_DECLINE) {

            } else {
                Toast.makeText(PaymentActivity.this, "Transaction is cancelled", Toast.LENGTH_SHORT).show();
    ...
    private void gotoNextStep(int requestCode, Intent data) {
        if (requestCode == Utils.AMOUNT_REQUEST_CODE) {
        ...
        if (requestCode == Utils.TIP_REQUEST_CODE) {
        ...
        if (requestCode == Utils.MULTI_OPERATOR_CODE_REQUEST_CODE) {
        ...
        if (requestCode == Utils.REFERENCE_NUMBER_REQUEST_CODE) {
