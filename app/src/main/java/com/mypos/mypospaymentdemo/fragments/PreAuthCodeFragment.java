...
public class PreAuthCodeFragment extends Fragment {
    ...
    public PreAuthCodeFragment(int requestCode, IFragmentResult resultListener) {
        super();
    ...
    private void init(View view) {
        ...
        keyboardHandler = new KeyboardHandler(getActivity(), view.findViewById(R.id.root_view), KeyboardHandler.INPUT_TYPE_CODE, true, 6);
        ...
        view.findViewById(R.id.charge_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!keyboardHandler.getCode().isEmpty()){
                    ...
                    intent.putExtra("preauth_code", keyboardHandler.getCode());
